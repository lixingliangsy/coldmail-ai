...
export const PIPELINE_ID = 'coldmail-ai-v1'
export const STEP_ORDER: StepId[] = ['input', 'process', 'output']
export const STEP_LABELS: Record<StepId, string> = {
  input: "Step 1/3 · Prospect + offer context",
  process: "Step 2/3 · Draft personalized email",
  output: "Step 3/3 · Subject variants + follow-up",
}
