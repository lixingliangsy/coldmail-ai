 ...
 *
 * <script src="https://YOUR_DOMAIN/widget.js" data-host="https://YOUR_DOMAIN" data-product="coldmail-ai" async></script>
 *
...
(function () {
  ...
  host = host.replace(/\/+$/, "");
  var product = (tag && tag.getAttribute("data-product")) || "coldmail-ai";
  ...
  function build() {
    ...
    var panel = null;
    var sessionKey = (product || "coldmail-ai") + "_chat_session";
