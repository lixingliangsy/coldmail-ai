      ...
      <main className="min-h-screen bg-slate-50 text-slate-900">
        <div className="max-w-xl mx-auto px-6 py-16">
          ...
          <section className="mt-8 rounded-2xl border border-slate-200 bg-white p-6">
            <h2 className="font-bold mb-2">Run history &amp; export</h2>
            <p className="text-sm text-slate-600 mb-4">
              Your workflow runs are stored server-side (never the browser). Export them as JSON for your records.
            </p>
            <div className="flex flex-wrap gap-3">
              <a href="/api/runs" className="px-4 py-2 rounded-full border border-slate-200 font-semibold text-sm">
                View runs (JSON)
              </a>
            </div>
          </section>
